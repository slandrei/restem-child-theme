...
<div class="absolute top-2 left-2">
	<?php if ( $is_vegetarian ) : ?>
        <div class="bg-kubio-color-4/50 p-1.5 rounded-lg shadow-sm" data-tippy-content="Vegetarian">
	...
	<?php else: ?>
        ...
        <div class="bg-kubio-color-4/50 backdrop-blur-sm p-1.5 rounded-lg shadow-sm" data-tippy-content="Non-Vegetarian">
