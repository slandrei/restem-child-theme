...
<div class="absolute top-2 left-2">
	<?php if ( $is_vegetarian ) : ?>
        <div class="bg-[#7BA05B] p-1.5 rounded-lg shadow-sm" data-tippy-content="Vegetarian">
	...
	<?php else: ?>
        ...
        <div class="bg-[#7BA05B]/80 backdrop-blur-sm p-1.5 rounded-lg shadow-sm" data-tippy-content="Non-Vegetarian">
