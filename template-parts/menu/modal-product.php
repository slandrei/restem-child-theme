...
<dialog id="product-modal"
        class="rounded-2xl bg-white p-0 max-w-lg w-full max-h-[90vh] overflow-visible fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-2xl border-0 backdrop:bg-black/85">
